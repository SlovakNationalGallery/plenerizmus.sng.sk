        ...
        data() {
            return {
                ...
                citations: [
                    ...
                    { message: 'Mnohokrát som prešiel týmto miestom, postál som a hlavou mi neprestajne vírilo, či vôbec treba túto krásnu krajinu pozorovať a preniesť do maľby. Hľadel som na zelenú trávu, modrú oblohu, plávajúce biele oblaky, pestrofarebné kvety a tmavé stromy. Videl som tú krajinu v plnom slnku, žiariacu v záplave farieb, a tiež pod závojom oblakov bez jediného tieňa...', author: 'Munkácsy Mihály'},
                    { message: 'Videl som tú krajinu v plnom slnku, žiariacu v záplave farieb, a tiež pod závojom oblakov bez jediného tieňa: postavu, trávu, strom, krík, ako sa rozplývajú v jemnej farebnej harmónii. Avšak, je toto možné zobraziť? Smel by som? Totiž nikdy v živote som to takto namaľované nevidel. Či by som sa k tomu odhodlal práve ja, na ktorého diela každý hľadí s odstupom? Takto som sa trápil ďalej.', author: 'Munkácsy Mihály'},
                    { message: 'Je to pozoruhodná krajina. Vôkol lesa Fontainebleau: osamelý ohromný dub – v letnej horúčave pod jeho lístím kostolný chlad. Keď príde jeseň, jeho rednúce listy šumia ako starobylý organ v Notre-Dame.', author: 'Munkácsy Mihály'},
